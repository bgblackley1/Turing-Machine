...
from src.TuringMachineFake import TuringMachineFake

class test_TuringMachine(unittest.TestCase):
    ...
    def test_machine_output_1_fake(self):
        test_machine = TuringMachineFake()
        return_value = test_machine.run_machine('0')
        self.assertEqual(return_value, ('q1', '0', '>'))

    def test_machine_output_2_fake(self):
        test_machine = TuringMachineFake()
        return_value = test_machine.run_machine('1')
        self.assertEqual(return_value, ('q0','1','>'))

    def test_machine_output_3_fake(self):
        test_machine = TuringMachineFake()
        return_value = test_machine.run_machine('2')
        self.assertEqual(return_value, ('qReject', '0', '-'))