...
class TuringMachineTkinter:
    ...
    def NPWindow(self):
        ...
        text = "It ran " + str(runs) + " times, the length of the input was " + str(
            len(self.input_entry.get())) + " digits long"
    ...
    def ListWindow(self):
        ...
        self.title_label = tk.Label(self.window_list,
                                    text="this function will loop through all values within 0 and a binary number, giving the output")
    ...
    def rules_type_input(self):
        self.window.destroy()
        self.window = tk.Tk()
        self.input_type_question_label = tk.Label(self.window, text="How would you like to input the rules?",
                                                  font=("Calbri Body", 10))
    ...
    def Many_inputs(self):
        ...
        self.format_example_label = tk.Label(self.window,
                                             text="'q0,0,q1,0,>', please follow this format, I would advise using clear accepted and rejected state")
    ...
    def starting_tape(self):
        ...
        self.submit = tk.Button(text="Submit", command=self.add_input_to_tape, height=2, width=6,
                                font=("Calbri Body", 10))
